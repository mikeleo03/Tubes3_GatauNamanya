...
function Profile(props) {
    return (
        <button className="profile-section md:h-18 h-12 flex flex-row space-x-1 mb-4 bg-gray-600 focus:bg-gray-500 hover:bg-gray-500 rounded-md px-3 w-full" onClick={() => props.logout()}>
