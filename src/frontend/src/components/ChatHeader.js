...
const ChatHeader = ({ pages, setPages, currentPage, openHistory, setOpenHistory }) => {
    ...
    return (
        <div className="h-14 py-3 w-full flex space-x-2">
            ...
            <div className='flex-item content-right' style={{float: 'right'}}>
                <button
                    ...
                    type="button"
                    className="bg-gray-700 inline-flex items-center justify-center p-2 py-1 rounded-md text-gray-400 hover:text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
